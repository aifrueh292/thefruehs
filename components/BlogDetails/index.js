                        ...
                        <div className="wpo-blog-content">
                            <div className="post format-standard-image">
                                ...
                                <div className="entry-meta">
                                    <ul>
                                        <li><i className="fi flaticon-user"></i> By <Link href="/blog-single/You-must-need-a-great-photographer.">{BlogDetails.author}</Link> </li>
                            ...
                            <div className="tag-share clearfix">
                                <div className="tag">
                                    <span>Share: </span>
                                    <ul>
                                        <li><Link href="/blog-single/You-must-need-a-great-photographer.">Planning</Link></li>
                                        <li><Link href="/blog-single/You-must-need-a-great-photographer.">photography</Link></li>
                                        <li><Link href="/blog-single/You-must-need-a-great-photographer.">creative</Link></li>
                                    </ul>
                                </div>
                            </div>
                            <div className="tag-share-s2 clearfix">
                                <div className="tag">
                                    <span>Share: </span>
                                    <ul>
                                        <li><Link href="/blog-single/You-must-need-a-great-photographer.">facebook</Link></li>
                                        <li><Link href="/blog-single/You-must-need-a-great-photographer.">twitter</Link></li>
                                        <li><Link href="/blog-single/You-must-need-a-great-photographer.">linkedin</Link></li>
                                        <li><Link href="/blog-single/You-must-need-a-great-photographer.">pinterest</Link></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="author-box">
                                <div className="author-avatar">
                                    <Link href="/blog-single/You-must-need-a-great-photographer." target="_blank"><img src={blog6} alt="" /></Link>
                                </div>
                                <div className="author-content">
                                    <Link href="/blog-single/You-must-need-a-great-photographer." className="author-name">Author: Jenny Watson</Link>
                                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis.</p>
                                    <div className="socials">
                                        <ul className="social-link">
                                            <li><Link href="/blog-single/You-must-need-a-great-photographer."><i className="ti-facebook"></i></Link></li>
                                            <li><Link href="/blog-single/You-must-need-a-great-photographer."><i className="ti-twitter-alt"></i></Link></li>
                                            <li><Link href="/blog-single/You-must-need-a-great-photographer."><i className="ti-linkedin"></i></Link></li>
                                            <li><Link href="/blog-single/You-must-need-a-great-photographer."><i className="ti-instagram"></i></Link></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div className="comment-wrapper">
                                                        ...
                                                        <div className="comment-area">
                                                            ...
                                                            <div className="comments-reply">
                                                                <Link className="comment-reply-link" href="/blog-single/You-must-need-a-great-photographer."><span>Reply</span></Link>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
